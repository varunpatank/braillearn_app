...
create index if not exists classes_creator_id_idx on public.classes (creator_id);
create index if not exists classes_level_idx on public.classes (level);
create index if not exists classes_category_idx on public.classes (category);
create index if not exists classes_fts_idx on public.classes using gin (fts);
create index if not exists class_progress_user_id_idx on public.class_progress (user_id);
create index if not exists class_progress_class_id_idx on public.class_progress (class_id);
